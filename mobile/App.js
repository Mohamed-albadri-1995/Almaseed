  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={{ flex: 1 }}>
        ...
        {top.name === 'material' && <MaterialScreen id={top.params.id} push={push} onBack={pop} onPlay={play} onStop={stopNow} onPip={enterPip} resumeMs={top.params.resumeMs} nowId={now?.id} />}
...
function MaterialScreen({ id, push, onBack, onPlay, onStop, onPip, resumeMs, nowId }) {
