...
function SeekBar({ position, duration, onSeek }) {
  ...
  return <View style={styles.seekWrap}>
    ...
    >
      <View style={styles.seekTrack}><View style={[styles.seekFill, { width: `${frac * 100}%` }]} /><View style={[styles.seekThumb, { right: `${frac * 100}%` }]} /></View>
    </View>
...
const styles = StyleSheet.create({
  ...
  full: { backgroundColor: '#12241d', borderRadius: 20, padding: 18, marginTop: 16, alignItems: 'center' }, fullArt: { width: 128, height: 128, borderRadius: 16, backgroundColor: C.brand, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', marginBottom: 12 }, fullArtGlyph: { color: C.gold300, fontSize: 46, fontWeight: '900' }, fullTitle: { color: C.white, fontSize: 17, fontWeight: '900', textAlign: 'center' }, fullPerson: { color: '#aebfb6', fontSize: 13, marginTop: 2, textAlign: 'center' }, seekWrap: { width: '100%', alignSelf: 'stretch', marginTop: 10, direction: 'rtl' }, seekHit: { width: '100%', paddingVertical: 12 }, seekTrack: { height: 8, borderRadius: 4, backgroundColor: '#3f6357', justifyContent: 'center' }, seekFill: { position: 'absolute', right: 0, height: 8, borderRadius: 4, backgroundColor: C.gold }, seekThumb: { position: 'absolute', width: 20, height: 20, borderRadius: 10, backgroundColor: C.gold, marginRight: -10, top: -6, borderWidth: 2, borderColor: '#12241d' }, seekTimes: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 4 }, seekTime: { color: '#e6efe9', fontSize: 12, fontWeight: '700' }, fullControls: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 14, marginTop: 10 }, fullSkip: { paddingHorizontal: 6, paddingVertical: 6 }, fullSkipTxt: { color: C.white, fontSize: 15, fontWeight: '800' }, fullPlay: { width: 62, height: 62, borderRadius: 31, backgroundColor: C.gold, alignItems: 'center', justifyContent: 'center' }, fullPlayIcon: { color: C.brand, fontSize: 22, fontWeight: '900' }, fullSpeed: { minWidth: 46, paddingHorizontal: 10, paddingVertical: 8, borderRadius: 12, backgroundColor: '#ffffff18', alignItems: 'center' }, fullSpeedTxt: { color: C.gold300, fontSize: 13, fontWeight: '900' }, fullStopTxt: { color: '#e0a39c', fontSize: 12, fontWeight: '800' },
