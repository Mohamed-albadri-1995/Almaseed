...
function SeekBar({ position, duration, onSeek }) {
  ...
  // Under RTL, RN mirrors the fill/thumb (start = right edge) but touch
  // coordinates stay physical (from the left), so map the touch accordingly —
  // otherwise dragging goes the wrong way.
