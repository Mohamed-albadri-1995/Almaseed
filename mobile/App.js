...
// Fallback icon per section, used when a material has no cover image.
const CAT_GLYPH = { madeeh: '🎵', lectures: '🎤', sermons: '📖', seminars: '👥', occasions: '📅', images: '🖼', readings: '📚' };
