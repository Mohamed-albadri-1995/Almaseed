    ...
    <div className="container-page py-14">
      <div className="mx-auto max-w-3xl space-y-10 leading-8 text-ink/90">
        ...
        <section id="deletion-policy" className="space-y-3">
          ...
          <ul className="list-disc space-y-2 pr-6 text-muted">
            <li>
              يمكن لأي من مشرفي القسم أن يفتح
              <span className="font-bold text-brand-800"> تصويت حذف</span> مع بيان سببه.
            </li>
            <li>
              يُقرَّر الحذف بـ<span className="font-bold text-brand-800">أغلبية مشرفي القسم</span>
              {' '}(أكثر من النصف)، ويشمل التصويت جميع مشرفي القسم — المراجعين والمستوى الذي
              فوقهم — بمن فيهم من وافق على المادة أول مرة. وصوت مقدّم الطلب يُحتسب موافقةً.
            </li>
            <li>
