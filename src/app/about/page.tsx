...
export const metadata: Metadata = {
  ...
  description: 'تعرّف على الطريقة السمّانية السجادة السليمانية ورسالة أرشيف المسيد في حفظ وتنظيم ونشر المدائح والمحاضرات والنوادر والمواعظ والمناسبات والاحتفالات.',
...
const VALUES = [
  {
    ...
    title: 'الطريقة السمّانية',
    body: 'طريقة صوفية سنّية قائمة على الكتاب والسنّة، تُنسب إلى قطبها الإمام السيد محمد بن عبد الكريم السمّان المدني، قوامها الذكر وتلاوة القرآن وتزكية النفوس والاقتداء بهدي النبي ﷺ.',
  },
  {
    icon: 'users' as const,
    title: 'السجادة السليمانية',
    body: 'امتداد الطريقة في مسيد أبورخم على نهج الأشراف، تتوارث خلافتها جيلاً بعد جيل، وخليفتها الحالي فضيلة مولانا الشريف هارون الشريف زين العابدين — أطال الله عمره.',
  },
  {
    icon: 'archive' as const,
    title: 'منهجٌ ومجالس',
    body: 'تعليم القرآن الكريم، وحلقات الذكر والمديح، ومجالس العلم والتربية الروحية — خدمةً لكتاب الله وأهله، وحفظاً لإرث المسيد ونقله إلى الأجيال.',
  },
];
      ...
      <section className="bg-brand-800 py-16 text-ivory-50">
        <div className="container-page text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl leading-8 text-ivory-100/85">
            طريقةٌ صوفية سنّية على نهج الأشراف، مقرّها مسيد أبورخم، تقوم على تعليم
            القرآن والذكر والمديح والتربية الروحية. وهذا فضاءٌ رقمي يحفظ ذاكرتها
            وينشر مدائحها ومحاضراتها وندواتها ومواعظها ومناسباتها بما يليق بمكانتها.
          </p>
        </div>
      </section>
