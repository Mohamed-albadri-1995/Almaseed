...
export const GUIDE_FLOWS: GuideFlow[] = [
  ...
  },
  {
    ...
    steps: [
      { t: 'في <strong>المعرض</strong> أو <strong>مدير الملفات</strong> أو <strong>مشغّل الصوت</strong>، اختر الملف (صوت أو فيديو أو صورة) واضغط <strong>«مشاركة»</strong>.' },
      { t: 'اختر <strong>«أرشيف المسيد»</strong> من قائمة المشاركة في أندرويد.' },
      { t: 'يفتح التطبيق على شاشة الإرسال والملف <strong>مُرفَق تلقائيًا</strong> — اختر <strong>القسم</strong> المناسب.' },
      { t: 'املأ <strong>الحقول الإلزامية</strong> (تتغيّر حسب القسم، وهي مطابقة تمامًا لنموذج الموقع).' },
      { t: 'علّم <strong>مربّعَي الإقرار</strong>، ثم اضغط <strong>«إرسال للمراجعة»</strong>.', btn: ['إرسال للمراجعة', 'primary'] },
    ],
